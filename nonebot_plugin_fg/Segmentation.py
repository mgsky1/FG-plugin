...
class WordSegmentation(object):
    ...
    def __init__(self, stop_words_file = None, allow_speech_tags = util.allow_speech_tags):
        ...
        # 将敏感词当作停顿词过滤掉
        for word in codecs.open(sys_config.fg_user_sensitive_dict_location):
            self.stop_words.add(word.strip)
    
    def segment(self, text, lower=True, use_stop_words=True, use_speech_tags_filter=True):
        ...
        # 加载自定义词典
        jieba.load_userdict(sys_config.fg_user_dict_location)
